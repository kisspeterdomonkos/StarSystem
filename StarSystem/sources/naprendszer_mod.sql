...
INSERT INTO `bolygok` (`id`, `nev`, `tavolsag`, `sebesseg`, `egyenlito`, `keringes`, `atmoszfera`) VALUES
...
(5, 'Jupiter', 778340821, 47002, 69911, 4333, 'Nitrogén, oxigén'),
...
--
-- Table structure for table `holdak`
--

CREATE TABLE `holdak` (
  `id` int(11) NOT NULL,
  `nev` text NOT NULL,
  `bolygo` int(11) NOT NULL,
  `felfedezes` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;

--
-- Dumping data for table `holdak`
--

INSERT INTO `holdak` (`id`, `nev`, `bolygo`, `felfedezes`) VALUES
...
--
-- Indexes for table `holdak`
--
ALTER TABLE `holdak`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bolygo` (`bolygo`);
...
--
-- AUTO_INCREMENT for table `holdak`
--
ALTER TABLE `holdak`
...
--
-- Constraints for table `holdak`
--
ALTER TABLE `holdak`
  ADD CONSTRAINT `holdak_ibfk_1` FOREIGN KEY (`bolygo`) REFERENCES `bolygok` (`id`);
COMMIT;
